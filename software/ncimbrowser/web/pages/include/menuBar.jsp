...
<table border="0" width="100%" class="global-nav" role='presentation'>
  <tr>
    <td align="left">
      <a href="<%= request.getContextPath() %>" tabindex="1">Home</a> |
      <a href="#" onclick="javascript:window.open('<%=request.getContextPath() %>/pages/source_hierarchy.jsf?&sab=<%=menu_bar_term_source%>', '_blank','top=100, left=100, height=740, width=680, status=no, menubar=no, resizable=yes, scrollbars=yes, toolbar=no, location=no, directories=no');" tabindex="2">
        NCIt Hierarchy</a> |
      <a href="#" onclick="javascript:window.open('<%=request.getContextPath() %>/pages/source_help_info.jsf',
        '_blank','top=100, left=100, height=740, width=680, status=no, menubar=no, resizable=yes, scrollbars=yes, toolbar=no, location=no, directories=no');" tabindex="3">
        Sources</a> |
      <a href="<%= request.getContextPath() %>/pages/help.jsf" alt="Help" tabindex="4">Help</a>
    </td>
    <td align="right">
	  <c:choose>	
