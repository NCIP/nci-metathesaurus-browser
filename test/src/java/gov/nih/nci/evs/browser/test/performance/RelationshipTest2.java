...
public class RelationshipTest2 extends DataUtils {
    ...
    public HashMap getAssociationTargetHashMap(String CUI, Vector sort_option) {
        ...
        DBG.debug(DBG.isDisplayDetails(), "* Details: " + CUI);
        return super.getAssociationTargetHashMap(CUI, sort_option);
    }
    ...
    public void getAssociationTargetHashMapTest(String scheme, String version, String code, Vector sort_option) {
        ...
        HashMap hmap = getAssociationTargetHashMap(code, sort_option);
    ...
    public static void main(String[] args) {
        try {
            ...
            RelationshipTest2 test = new RelationshipTest2();
